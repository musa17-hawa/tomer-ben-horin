...
function GalleryEditModal({ isOpen, onClose, onSave, gallery }) {
  ...
  useEffect(() => {
    if (gallery) {
      setForm({
        ...
        image: null,
        status: gallery.status || 'open',
        imageUrl: gallery.imageUrl || '',
      });
      setPreviewImage(gallery.imageUrl || null);
    } else {
  ...
  return (
    <div className="modal-backdrop">
      <div className="modal-container">
        ...
        <h2 className="modal-title">ערוך גלריה</h2>
            ...
            <div className="modal-field">
              ...
              <div className="custom-image-upload">
                ...
                <input
                  ...
                  style={{ display: 'none' }}
                />
                <label htmlFor="gallery-edit-image-upload" className="custom-upload-btn">
